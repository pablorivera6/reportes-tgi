...
a = Analysis(
    ...
    pathex=[],
    binaries=[],
    datas=[('EN BLANCO.xlsx', '.'), ('CIPS EN BLANCO.xlsx', '.'), ('Infra_General_TGI_V11_29032023.kmz', '.'), ('Infraestrutura TGI.xlsx', '.'), ('Listado equipos TGI.xlsx', '.'), ('consolidado OT.xlsx', '.'), ('PPM.XLSX', '.'), ('DCVG_PPM_.xlsx', '.'), ('DCVG_REP.xlsx', '.'), ('ot_por_tipo.csv', '.'), ('Listado de Infraestructura para Cod Informes.xlsx', '.'), ('shapefiles.zip', '.'), ('iconos_kml', 'iconos_kml')],
